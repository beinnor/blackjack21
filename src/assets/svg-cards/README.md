...
The naming of the cards is _not_ kept as in the original (because of SVG standard compliance):
...
- _card-base_, with the same dimensions as a card
- _suit-club_
- _suit-heart_
- _suit-diamond_
- _suit-spade_
...
[xmllint](http://xmlsoft.org/xmllint.html): `xmllint --noblanks svg-cards-indented.svg > svg-cards.svg`
